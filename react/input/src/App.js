...
export default function App() {
  ...
  // users: 현재까지 등록된 사용자 객체들의 배열관리 - 초기 사용자는 3명
...
// 사용자 입력 -> CreateUser(input)에서 onChange 발생 -> App의 onChange함수 실행 ->
// App의 state변경(setInputs) -> 새로운 props가 CreateUser에 전달 -> 화면이 최신 상태로 반영
