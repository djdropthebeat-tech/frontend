...
// 각 메뉴는 lable(메뉴명), items(하위메뉴 배열)
const heroSlides = ['i_01','i_02','i_03','i_04',];
// 메인 슬라이드 이미지 클래스 배열명


// 클래식, 프레쉬&라이트, 프리미엄, 아침메뉴 네 개의 카테고리

// 아이템데이터 -> 각 아이템 name, image, description(문자열 배열)
...
const sliderSetting = {
  ...
  dotsClass: 'dot-list', //커스텀 도트 클래스명
          ...
          <div className="menu_top cf">
            ...
            <ul className="mt_right">
              {menuCategories.map((category, index)=>(
                <li 
                  key={category.label}
                  className={`${index === menuCategories.length -1 ? 'last':''}
