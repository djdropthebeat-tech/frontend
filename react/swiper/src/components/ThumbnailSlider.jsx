  ...
  return (
    <div className="thumbnail-swiper-container">
      <Swiper
        ...
        // thumbsSwiper.destroyed 가 파괴되지 않았는지 확인
        // 조건이 참이면 thumbsSwiper//
        // thumbnailSwiper - 썸네일 슬라이더의 인스턴스 참고, useState(null)로 초기화
        // 하단 썸네일 슬라이더의 onSwiper={setThumbsWiper}로 설정됨
